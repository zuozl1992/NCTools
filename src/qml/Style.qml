...
QtObject {
    ...
    // Fonts
    readonly property font defaultFont: Qt.font({ family: "System", pixelSize: 13 })
    readonly property font headerFont: Qt.font({ family: "System", pixelSize: 14, weight: Font.Bold })
    readonly property font smallFont: Qt.font({ family: "System", pixelSize: 11 })
